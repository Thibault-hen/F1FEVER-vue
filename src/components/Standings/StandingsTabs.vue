<template>
  <TabGroup>
    <div class="flex md:items-end flex-col-reverse md:flex-row">
      <TabList
        class="flex p-2 bg-white dark:bg-dark-2 rounded-lg border shadow dark:border-slate-50/[0.06] md:mt-0 mt-4"
      >
        <Tab
          selected
          class="text-sm w-full md:w-auto xl:text-base py-2 px-6 ui-selected:bg-primary ui-selected:text-white ui-not-selected:bg-white ui-not-selected:dark:bg-dark-2 ui-not-selected:text-black ui-not-selected:dark:text-white rounded border-none outline-none"
    ...
    <TabPanels
      class="relative flex bg-white dark:bg-dark-2 rounded border dark:border-slate-50/[0.06] w-full p-2"
    >
      <div
