<template>
  <div class="relative flex">
    <Listbox v-model="selectedSeason" as="div" v-slot="{ open }">
      <ListboxButton
        class="bg-white dark:bg-dark-1 dark:text-white p-2 rounded-lg w-52 shadow border dark:border-slate-100/[0.20] text-left flex justify-between dark:ui-open:border-primary ui-open:border-primary"
      >
      ...
      >
        ...
        >
          <ListboxOption
            ...
            class="py-1 ui-active:bg-primary ui-active:bg-opacity-10 ui-active:text-primary ui-not-active:bg-white ui-not-active:dark:bg-dark-1 ui-not-active:text-black ui-not-active:dark:text-white text-center"
          >
            {{ season.year }}
          </ListboxOption>
        </ListboxOptions>
